...
class __TwigTemplate_9fe654904368533178cb0f60417471d4 extends Template
{
...
(isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 201, $this->source); })()), "enabled", [], "any", false, false, false, 201)) {
            ...
            yield "\">
                ...
                <div class=\"tab-content\">
                    ";
            // line 318
            if ( !Twig\Extension\CoreExtension::testEmpty(((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "authenticators", [], "any", true, true, false, 318)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 318, $this->source); })()), "authenticators", [], "any", false, false, false, 318), [])) : ([])))) {
                // line 319
                yield "                        <table>
                            <thead>
                            <tr>
            ...
            yield "\">
                ...
                <div class=\"tab-content\">
                    ";
            // line 363
            if ( !Twig\Extension\CoreExtension::testEmpty(((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "voters", [], "any", true, true, false, 363)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 363, $this->source); })()), "voters", [], "any", false, false, false, 363), [])) : ([])))) {
                // line 364
                yield "                        <div class=\"metrics\">
                            <div class=\"metric\">
                                <span class=\"value\">";
            ...
            // line 389
            yield "                    ";
            if ( !Twig\Extension\CoreExtension::testEmpty(((CoreExtension::getAttribute($this->env, $this->source, ($context["collector"] ?? null), "accessDecisionLog", [], "any", true, true, false, 389)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 389, $this->source); })()), "accessDecisionLog", [], "any", false, false, false, 389), [])) : ([])))) {
                // line 390
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/home/rodrialeh/Documentos/CursoSymfony/curso_1_cli/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
