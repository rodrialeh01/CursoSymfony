...
class __TwigTemplate_435d75d165a77c14f1dab14729776da1 extends Template
{
...
";
    ...
    ";
        // line 164
        if (Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 164, $this->source); })()), "messages", [], "any", false, false, false, 164))) {
            // line 165
            yield "        ";
...
";
    ...
    ";
        // line 204
        if ( !Twig\Extension\CoreExtension::length($this->env->getCharset(), CoreExtension::getAttribute($this->env, $this->source, (isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 204, $this->source); })()), "messages", [], "any", false, false, false, 204))) {
            // line 205
                ...
                if (CoreExtension::getAttribute($this->env, $this->source, (isset($context["message"]) || array_key_exists("message", $context) ? $context["message"] : (function () { throw new RuntimeError('Variable "message" does not exist.', 309, $this->source); })()), "attachments", [], "any", false, false, false, 309)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["attachment"]) {
                        ...
                        yield "
                                            ...
                                            ";
                        // line 323
                        if (((CoreExtension::getAttribute($this->env, $this->source, $context["attachment"], "filename", [], "any", true, true, false, 323)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, $context["attachment"], "filename", [], "any", false, false, false, 323))) : (""))) {
                            // line 324
                            yield "                                                ";
...
{% block panel %}
    ...
    {% endmacro %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/home/rodrialeh/Documentos/CursoSymfony/curso_1_cli/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
