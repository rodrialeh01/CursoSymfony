...
class getAssetMapper_Importmap_ManagerService extends App_KernelProdContainer
{
    ...
    {
        return $container->privates['asset_mapper.importmap.manager'] = new \Symfony\Component\AssetMapper\ImportMap\ImportMapManager(($container->privates['asset_mapper'] ?? $container->load('getAssetMapperService')), ($container->privates['asset_mapper.public_assets_path_resolver'] ??= new \Symfony\Component\AssetMapper\Path\PublicAssetsPathResolver(\dirname(__DIR__, 4), '/assets/', 'public')), (\dirname(__DIR__, 4).'/importmap.php'), (\dirname(__DIR__, 4).'/assets/vendor'), new \Symfony\Component\AssetMapper\ImportMap\Resolver\PackageResolver('jsdelivr.esm', new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
